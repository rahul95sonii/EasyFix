...
public final class GoogleAuthHelper {
	 ...
	 */
//	private static final String CALLBACK_URI = "http://localhost:8080/easyfix/login";
//	private static final String CALLBACK_URI = "https://uat.easyfix.in/easyfix/login";
	private static final String CALLBACK_URI = "https://core.easyfix.in/easyfix/login";
	...
	public String buildLoginUrl() {
		...
		redirectUrl = url.setRedirectUri(CALLBACK_URI).setState(stateToken).build();
		return "redirect";
	}
